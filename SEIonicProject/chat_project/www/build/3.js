...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__message__ = __webpack_require__(607);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(188);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_chat_chat_service__ = __webpack_require__(335);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_angular2_uuid__ = __webpack_require__(189);
...
var MessagePage = /** @class */ (function () {
    function MessagePage(navCtrl, navParams, chat) {
        var _this = this;
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.chat = chat;
        this.chat.chat.subscribe(function (data) {
            _this.mex = data.sort(function (a, b) {
                return a.datetime - b.datetime;
            });
            _this.scrollBottom(1000, 0);
        });
    }
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        message = {
                            ...
                            content: content,
                            mykey: __WEBPACK_IMPORTED_MODULE_3_angular2_uuid__["UUID"].UUID(),
    ...
    MessagePage.prototype.scrollBottom = function (duration, timeout) {
        var _this = this;
    ...
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_9" /* ViewChild */])('scrollBottom'),
        __metadata("design:type", __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["b" /* Content */])
    ], MessagePage.prototype, "content", void 0);
    MessagePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'page-message',template:/*ion-inline-start:"/Users/danilogiovannico/Desktop/SEIonicProject/chat_project/src/pages/message/message.html"*/'<ion-header>\n  <ion-navbar>\n    <ion-title>{{ selectedProfile?.firstName }} {{ selectedProfile?.lastName }}</ion-title>\n  </ion-navbar>\n</ion-header>\n<ion-content padding id="messagesContent" #scrollBottom>\n\n  <ion-item id="messagesContentChild" no-lines *ngFor="let message of mex">\n    <ion-item no-lines class="chat-message__message-right chatmessage" *ngIf="message.userFromId === userId; else from">\n\n      <div item-right id="sender" text-wrap class="chatmessage">\n        <!--<h2>{{ message?.userFromProfile?.firstName }} {{ message?.userFromProfile?.lastName }}</h2>-->\n        <p class="text">{{ message.content}}</p>\n        <p class="data">{{ message.datetime | date:\'medium\'}}</p>\n      </div>\n      <ion-avatar class="avatar" item-end>\n        <img src="assets/imgs/profile-placeholder.png" alt="Avatar">\n      </ion-avatar>\n    </ion-item>\n\n    <ng-template #from>\n      <ion-item no-lines class="chatmessage">\n        <ion-avatar class="avatar" item-left>\n          <img src="assets/imgs/profile-placeholder.png" alt="Avatar">\n        </ion-avatar>\n        <div item-left id="receiver" text-wrap class="chatmessage">\n          <!--<h2>{{ message?.userFromProfile?.firstName }} {{ message?.userFromProfile?.lastName }}</h2>-->\n          <p class="text">{{ message.content}}</p>\n          <p class="data">{{ message.datetime | date:\'medium\'}}</p>\n        </div>\n      </ion-item>\n    </ng-template>\n\n  </ion-item>\n\n</ion-content>\n\n<ion-footer>\n  <ion-toolbar>\n    <app-send-message-box (sendMessage)="sendMessage($event)"></app-send-message-box>\n  </ion-toolbar>\n</ion-footer>\n'/*ion-inline-end:"/Users/danilogiovannico/Desktop/SEIonicProject/chat_project/src/pages/message/message.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* NavParams */], __WEBPACK_IMPORTED_MODULE_2__providers_chat_chat_service__["a" /* ChatService */]])
    ], MessagePage);
    return MessagePage;
}());
