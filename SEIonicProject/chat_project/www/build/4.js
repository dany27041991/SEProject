...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__login__ = __webpack_require__(606);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(188);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_data_data_service__ = __webpack_require__(334);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var LoginPage = /** @class */ (function () {
    function LoginPage(toast, navCtrl, data) {
        this.toast = toast;
        this.navCtrl = navCtrl;
        this.data = data;
    }
    LoginPage.prototype.login = function (event) {
        ...
        if (!event.error) {
            ...
            this.data.getProfile(event.result.user).subscribe(function (profile) {
                ...
                profile ? _this.navCtrl.setRoot('TabsPage') : _this.navCtrl.setRoot('EditProfilePage');
            });
        }
        else {
            this.toast.create({
    ...
    LoginPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'page-login',template:/*ion-inline-start:"/Users/danilogiovannico/Desktop/SEIonicProject/chat_project/src/pages/login/login.html"*/'<ion-header>\n  <ion-navbar color="dark">\n    <ion-title>Home</ion-title>\n  </ion-navbar>\n</ion-header>\n<ion-content padding>\n\n  <img src="assets/imgs/mylogo.png" alt="Logo">\n\n  <app-login-form (loginStatus)="login($event)"></app-login-form>\n\n</ion-content>\n'/*ion-inline-end:"/Users/danilogiovannico/Desktop/SEIonicProject/chat_project/src/pages/login/login.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["k" /* ToastController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* NavController */], __WEBPACK_IMPORTED_MODULE_2__providers_data_data_service__["a" /* DataProvider */]])
    ], LoginPage);
    return LoginPage;
}());
