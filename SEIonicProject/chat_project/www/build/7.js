...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__channels__ = __webpack_require__(604);
...
var ChannelsPage = /** @class */ (function () {
    ...
    ChannelsPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'page-channels',template:/*ion-inline-start:"/Users/danilogiovannico/Desktop/SEIonicProject/chat_project/src/pages/channels/channels.html"*/'<ion-header>\n  <ion-navbar>\n    <ion-title>Channels</ion-title>\n    <ion-buttons end>\n      <button ion-button icon-only (click)="showAddChannelDialog()">\n        <ion-icon name="add"></ion-icon>\n      </button>\n    </ion-buttons>\n  </ion-navbar>\n</ion-header>\n<ion-content padding>\n  <ion-list>\n    <ion-item *ngFor="let channel of channelList | async" (click)="selectChannel(channel)">\n      #{{ channel.name }}\n    </ion-item>\n  </ion-list>\n</ion-content>\n'/*ion-inline-end:"/Users/danilogiovannico/Desktop/SEIonicProject/chat_project/src/pages/channels/channels.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* NavParams */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["a" /* AlertController */], __WEBPACK_IMPORTED_MODULE_2__providers_chat_chat_service__["a" /* ChatService */]])
    ], ChannelsPage);
    return ChannelsPage;
}());
