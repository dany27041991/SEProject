...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__channel_chat__ = __webpack_require__(602);
...
var ChannelChatPage = /** @class */ (function () {
    function ChannelChatPage(navCtrl, navParams, chat) {
        this.navCtrl = navCtrl;
    ...
    ChannelChatPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'page-channel-chat',template:/*ion-inline-start:"/Users/danilogiovannico/Desktop/SEIonicProject/chat_project/src/pages/channel-chat/channel-chat.html"*/'<ion-header>\n  <ion-navbar>\n    <ion-title>{{ channel.name }}</ion-title>\n  </ion-navbar>\n</ion-header>\n<ion-content padding>\n  <ion-list>\n    <ion-item *ngFor="let message of channelMessages | async">\n      <p>{{ message.content }}</p>\n    </ion-item>\n  </ion-list>\n</ion-content>\n\n<ion-footer>\n  <ion-toolbar>\n    <app-send-message-box (sendMessage)="sendMessage($event)"></app-send-message-box>\n  </ion-toolbar>\n</ion-footer>'/*ion-inline-end:"/Users/danilogiovannico/Desktop/SEIonicProject/chat_project/src/pages/channel-chat/channel-chat.html"*/,
        }),
